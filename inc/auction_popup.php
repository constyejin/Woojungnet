...
<!--<td width="100" height="30" align="left" valign="middle"><input type="button" style="height:30;color:#000000"  value="인쇄하기" onclick="window.print()"></td>/-->    
		<td height="50" align="left" valign="middle"><strong>⊙입찰자명단 (접수번호 : <?=$auction[wc_orderno]?> / 차량번호 : <?=$auction[wc_no]?> / 차량이름 : <?=$auction[wc_model]?>)</strong><br>
		  (접수일자 :  <strong>2015년   01월  01일</strong>  /  매각방식 : <strong>경매(파손)</strong>  / 낙찰일시 : <strong>2015년 00월 00일</strong> / 보험사접수번호 : <strong>15-00654939 자차 001</strong>)</td>
...
<? if($loginUsort == "superadmin" || $loginUsort == "admin") { ?>
        ...
        {?>
        	...
        	<td height="38" colspan="9" align="center"><span class="style4">검색된 자료가 없습니다.</span></td>	
