<header>
    ...
    <!-- nav -->
    <nav class="nav">
        <img src="/images/front/main_logo_white.png" class="logo-white" alt="SKRCAUTO 로고" onClick="location.href='/';">
        <img src="/images/front/main_logo.png" class="logo-black" alt="SKRCAUTO 로고" onClick="location.href='/';">
        <ul class="nav-list depth-01">
            ...
            <li><a href="/sub07/sub07_1.php"><span class="item">보유차량</span></a></li>
