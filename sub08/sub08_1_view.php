...
function part_del(idx){
	if(confirm('삭제 하시겠습니까?')){
		location.href="sub08_1_del2.php?wc_idx="+idx;
	}
}
</script>
    ...
    <table style="width:1200px;margin: 0 auto; margin-top:0px;" border="0" cellspacing="0" cellpadding="0">
      ...
      <tbody style="border: 1px solid #cccccc"> 
        ...
        <tr>
          ...
          <td width="127" height="50" align="center" bgcolor="#f2f2f2" style="padding-right: 5px;  padding-top: 2px; border-right:1px solid #CCCCCC; border-bottom:1px solid #CCCCCC;color: #888888;font-size: 14px;font-weight: bold">가격 Price</td>
          <td width="200" height="50"  align="center"  bgcolor="#FFFFFF" style="padding-left: 5px; padding-top: 2px; border-right:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC; font-size: 15px;font-weight: bold"><?=$row[wc_cost]!="1"?number($row[wc_keep_tel1])."만원":"할부가능"?></td>
        </tr>
...
if($loginUsort == "admin" || $loginUsort == "admin2" || $loginUsort == "admin3" || $loginUsort == "superadmin" || $loginUsort == "jisajang2"){
?>
				<!--<a href="sub08_1_write.php?wc_idx=<?=$wc_idx?>"><img src="/images/edit_bt.jpg" /></a>-->
        <a href="sub08_1_write.php?wc_idx=<?=$wc_idx?>" style="display:inline-flex; justify-content: center; align-items:center;border: 2px solid #cc3535; border-radius: 20px; min-width: 80px; height: 32px;font-size: 12px;font-weight: 600;color: #cc3535;margin-left: 10px; ">수정하기</a>
<?
}
?>
					</td>
