...
?>
			<div class="tab_type01">
				<ul>
                    <li <?=$on1 ?>><a href="/sub03/sub03_1.php"><span><?=$kk?></span></a></li>
					<? if($gubun2=="2"){ ?>
					...
					<tr>
						...
						<td style="text-align:right; padding-right: 30px">
							...
							<div class="filter-group">
								<a href="sub03_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&type=1">폐차</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub03_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&type=2">명의이전</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub03_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&evaltype=1">전손</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub03_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&evaltype=2">분손</a></a>
							</div>
						</td>
						</form>
					</tr>
...
function auctionView(idx,gubun2) {
	window.location.href="sub03_1_view.php?gubun2="+gubun2+"&idx="+idx;
}
function zzim(idx){
