    ...
    <div class="filter car-sale">
        <ul>
            <li <?= !$gubun3 ? 'class="active"' : "" ?>>
                <button onclick="location.href='sub04_1.php?gubun2=2';">전체보기</button>
            </li>
            <li <?= $gubun3 == "3" ? 'class="active"' : "" ?>>
                <button onclick="location.href='sub04_1.php?gubun2=2&gubun3=3';">공매(파손)</button>
            </li>
            <li <?= $gubun3 == "6" ? 'class="active"' : "" ?>>
                <button onclick="location.href='sub04_1.php?gubun2=2&gubun3=6';">공매(침수)</button>
            </li>
            <li <?= $gubun3 == "2" ? 'class="active"' : "" ?>>
                <button onclick="location.href='sub04_1.php?gubun2=2&gubun3=2';">경매(파손)</button>
            </li>
            <li>
        ...
        <div class="btn-list">
            <button <?= $type == "1" ? 'class="active"' : "" ?>
                onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&type=1';">폐차</button>
            <button <?= $type == "2" ? 'class="active"' : "" ?>
                onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&type=2';">명의이전</button>
            <button <?= $evaltype == "1" ? 'class="active"' : "" ?>
                onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&evaltype=1';">전손</button>
            <button <?= $evaltype == "2" ? 'class="active"' : "" ?>
                onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&evaltype=2';">분손</button>
            <!-- 
        <button <?= $t == "9" ? 'class="active"' : "" ?> onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&t=9';">09:30마감</button>
        <button <?= $t == "10" ? 'class="active"' : "" ?> onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&t=10';">10:30마감</button>
        <button <?= $t == "13" ? 'class="active"' : "" ?> onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&t=13';">13:30마감</button>
        <button <?= $t == "15" ? 'class="active"' : "" ?> onclick="location.href='sub04_1.php?gubun2=<?= $gubun2 ?>&gubun3=<?= $gubun3 ?>&t=15';">15:30마감</button>
				 -->
        </div>
</section>
</div>
...
<section class="car-list-wrap">
    ...
    <div class="car-list swiper">
        <ul class="swiper-wrapper">
			...
			?>
            <li class="swiper-slide" onclick="window.location='./sub04_1_view.php?idx=<?= $row->wc_idx ?>'">
                <div class="carbox">
