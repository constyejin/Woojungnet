			...
			<div class="search-box">
			   ...
			   <input type="hidden" name="gubun3" value="<?=$gubun3?>" >
				<table width="" border="0" cellspacing="0" cellpadding="0" style="padding-top:3px; border:1px solid #CCCCCC;">
					<tr>
						<td style="height: 36px;text-align:left;padding-left:30px;">
						...
						<td style="text-align:right; padding-right: 30px">
							...
							<div class="filter-group">
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&type=1">폐차</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&type=2">명의이전</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&evaltype=1">전손</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&evaltype=2">분손</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&t=11">09:30 마감</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&t=2">10:30 마감</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&t=2">13:30 마감</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub02_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&t=2">15:30 마감</a>
							</div>
						</td>
						</form>
					</tr>
...
$view_article = 20; // 한화면에 나타날 게시물의 총 개수  
				...
				<div class="carbox" onclick="<?=$onc?>" style="cursor:pointer">
						...
						<div class="number">
							...
							<div class="n_tit"><span>
												<? 
													WriteArrHTML('select', 'gubun3', $Arrgubun3_2s, $row->wc_gubun3, '', '' , 'direct', ''); 
												?></span></div>
						</div>
						...
						<div class="carname">
							...
							?>
                            /  <?=$row->wc_mem_name=="동부"?$row->made_dong:$row->wc_model ?>
								-->
							 <?=$row->wc_model?>
			...
			<!--  페이지네이션 -->
			<table cellpadding="0" cellspacing="0" class="pagination">
				<tr>
					<td height="15" align="center">&nbsp;</td>
				</tr>
				<tr>
					<td align="center"><table width=100%><tr><td height="50" align=center > <span ><? include "../inc/page.php";?></td>
					</tr></table> </td>
				</tr>
				<tr>
					<td height="15" align="center">&nbsp;</td>
