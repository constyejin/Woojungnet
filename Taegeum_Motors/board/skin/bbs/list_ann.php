<table width="<?=$table_width?>" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
        ...
        <?=$show_admin_yn_s?><?// chk값은 어드민 계정을 이용한 자료 이동및 관리를 위해 사용됩니다.
                               // 1. checkbox 이름 ::> chk
                               // 2. value         ::> $no ?>
        <td width="40" height="30" align="center"><input type="checkbox" name="chk" value="<?=$admin_no?>"></td>
        <td width="1" align="center"><img src="<?=$skinDir?>images/line_02.gif" width="1" height="30"></td>
        <?=$show_admin_yn_e?>

        <?=$hide_no_s      ?>
        <td width="40" align="center" class="text_02"><strong><font color=806A1F>공지</font></strong></td>
        <td width="1" align="center"><img src="<?=$skinDir?>images/line_02.gif" width="1" height="30"></td>
        <?=$hide_no_e      ?>
        ...
        <?=$hide_name_s    ?>
        <td width="1"><img src="<?=$skinDir?>images/line_02.gif" width="1" height="30"></td>
        <td width="80" align="center" class=text_03><b>
        ...
        <?=$hide_reg_date_s?>
        <td width="1"><img src="<?=$skinDir?>images/line_02.gif" width="1" height="30"></td>
        <td width="80" align="center"><?=$reg_year?>.<?=$reg_month?>.<?=$reg_day?></td>
        <?=$hide_reg_date_e?>
