<table width=100% border="0" cellpadding="0" cellspacing="0">
  <tr><td align=center style="font-size:15px;"> <span>
<? 
...
if ($page != 1)           echo "[<a href=".$PHP_SELF."?page=1".$href.">맨처음</a>] ";  
else                      echo "[맨처음] ";  
 
if ($page != 1)           echo "[<a href=".$PHP_SELF."?page=".$prev_group.$href.">이전</a>] ";  
// else                      echo "[<<] ";  
/* 
...
*/ 
if ($page != $total_page) echo "  [<a href=".$PHP_SELF."?page=".$next_group.$href.">다음</a>]   ";  
//else                      echo "  [>>]   ";  
 
if ($page != $total_page) echo "  [<a href=".$PHP_SELF."?page=".$total_page.$href.">마지막</a>]  ";  
else                      echo "  [마지막]   ";  
