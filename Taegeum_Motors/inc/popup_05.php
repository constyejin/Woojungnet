...
<form name="gamform" method="post" enctype="multipart/form-data" target="HiddenFrm" action="gam_ok.php">
...
<?}else{?>
            <a href="javascript:gam_ok();">발급하기</a> / 
<?}?>
...
<table width="600" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
          <tr>
            <td width="100" height="25" align="center" bgcolor="#f6f6f6">감정구분</td>
            <td height="25" colspan="3" bgcolor="#ffffff" style="padding-left:3px;">&nbsp;<?=$row[wcj_type]?></td>
            </tr>
              <tr> 
