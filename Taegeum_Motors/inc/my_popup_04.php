...
.apply-receive-table td.style1 {
	font-size: 22px;
	font-weight: bold;
}
.apply-receive-table td, .apply-receive-table th{
  font-size: 12px;
}
</style>
</head>
...
<body>
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="apply-receive-table">
