	...
	-------------------------------------------------------------------*/
		...
		function Editor_Defaule_Config(EditorObjName){
			...
			this.ImagePath		=	'/board/webeditor/editor_image/'		//**	에디터 그림 경로
			...
			this.DefaultStyle	=	  '<style type="text/css">\n'
									+ '	body	{font-size: 10pt; font-family: 굴림, 돋음; font-style:  normal; font-weight: normal;color: 6a6a6a;background-color:#ffffff;}\n'
			...
			//**	에디터 버튼 정의
				this.ButtonList	=	{
					//**				버튼 이름				:	 아이디					설명				클릭시 실행				이미지 경로
										...
										'inserthorizontalrule'	:	['InsertHorizontalRule','가로줄',			'Editor_ACT(this.id)',		'toolbar_hr.gif'],
