			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="90%">
					<tr>
						...
						<td width="25%">
						<input type="checkbox" name="WidthUse" value="1" style="width:20; cursor:hand;" OnClick="javascript:FUN_WidthUse(this);" unselectable="on">너비지정:</td>
						<td width="25%" valign="bottom">
						<input type="radio" value="" name="WidthType" style="width:20; cursor:hand;" unselectable="on" disabled>픽셀 
						단위</td>
					</tr>
					<tr>
						<td width="25%">배치:</td>
						...
						<td width="25%">
						<input type="text" name="Width" size="20" value="100" style="width: 90%; font-size: 9pt; font-family: 굴림, 돋음; font-style: normal; font-weight: normal" disabled></td>
						<td width="25%" valign="bottom">
						<input type="radio" value="%" checked name="WidthType" style="width:20; cursor:hand;" unselectable="on" disabled>백분율</td>
					</tr>
					<tr>
