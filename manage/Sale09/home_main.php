...
<form name="subMain" method="post" action="home_main_save.php"  enctype="multipart/form-data">
...
<tr>
	...
	<input type="file" name="imgfile" size="130">
      <span class="style3"> *  크기: 2000 * 900  </span></td>
</tr>
<tr>
...
<?
$sql="select * from home_main where type='1' order by list_num asc";
...
<td><?=$data[view]?></td>
<td><a href="home_main.php?idx=<?=$data[idx]?>">수정</a> / <a href="home_main_del.php?idx=<?=$data[idx]?>">삭제</a></td>
</tr>
<?
}
?>
