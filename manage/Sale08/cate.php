...
<?
if($midx) $data=mysql_fetch_array(mysql_query("select * from cate where idx=$midx"));

if( $InsuName && $mode == "Ins" ){
//idx  code  depth  name  
	if(!$idx){ // 최상위 등록

		$SQL = "insert into cate (depth, name, sort_list) values ('1', '".$InsuName."', ".$sort_list.") ";
		...
		$SQL = "insert into cate (code, depth, name, sort_list) values ( '".$idx."', '2','".$InsuName."', ".$sort_list.") ";
		$rIns = mysql_query($SQL);
		if($rIns){
			MsgMov("등록되었습니다.","$PHP_SELF?idx=".$idx."&name=".$name."");
		}
...
if( $InsuName && $mode == "edit" && $idx){
	...
	$SQL1 = "update cate set  name  = '".$InsuName."', sort_list = ".$sort_list." where idx=".$idx." ";
...
if(  $mode == "del" && $idx){
	...
	$SQL1 = "delete from cate  where idx=".$idx." ";
	$rIns1 = mysql_query($SQL1);

	$SQL2 = "delete from cate  where code=".$idx." ";
  ...
  <tr> 
    <td>
      <table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" align="left" style="color:#333399"> <font size="-4"> ▶ </font>위치 : 변속기, 연료</td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td width="862" align="left" class="title"><img src="/manage/img/icon02.gif" width="15" height="15" align=absmiddle /> <strong>변속기, 연료</strong></td>
        </tr>
      </table>
    </td>
  </tr>
          ...
          <td height="30" align="center" valign="middle" bgcolor="#f6f6f6">
              ...
              <form name="frmInsu" method="post" onSubmit="return ChkInsu()">
                ...
                <tr bgcolor="#f6f6f6"> 
                  ...
                  <td width="76" align="left" valign="middle" style="padding:0 0 0 10"><strong>제휴업체명</strong></td>
                  <td align="left" valign="middle"><input name="InsuName" type="text" id="InsuName" size="20" /></td>
                  <td align="left" valign="middle"> <input type="submit" name="subname" value="등록" class="button333" style="cursor:pointer; background-color:#FFFFFF; color:#ff0000; border:#636563 1px solid; padding:2 0 0 0; font-weight:bold">&nbsp;<input type="button" name="subname22" id="subnam22e" value="취소" onClick="freset();" class="button4" style="cursor:pointer; background-color:#FFFFFF; color:#ff0000; border:#636563 1px solid; padding:2 0 0 0; font-weight:bold"> 
                  </td>
                </tr>
              </form>
            </table></td>
        ...
        <tr> 
          <td  height="102" align="left" valign="top" bgcolor="#FFFFFF" style="padding-left:5px;"> 
            <table width="190" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height=30><span class="style4"><a href="./cate.php"><b>/최상위</b></a></span></td>
              </tr>
            </table>
...
<input type="hidden" name="subidx" value="<?=$idx?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <?
	    $qry = "SELECT * FROM cate Where depth=1 order by sort_list asc ";
...
?>
          ...
          <td width="296" height="102" align="left" valign="top" bgcolor="#FFFFFF" style="padding-left:3px;"><table width="434" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="434" height="18" align="left" valign="top"><a href="#"><img src="../img/admin_setting_pol_2.gif" width="12" height="13" border="0" />..</a></td>
              </tr>
            </table>
            <table  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="436" height="20" align="left" valign="top"><table width="435" border="0" cellspacing="0" cellpadding="0">
                    <?
if($idx){
	    $qryS = "SELECT * FROM cate Where depth=2 and code=".$idx." order by sort_list,name asc";
