...
$image_sub=sql_list("select * from image_sub where sub_type='sub' order by idx desc ");
?>
    <!-- 본문 -->
                  ...
                  <td>
                    <div class="row">
                      ...
                      <div class="col-auto d-flex align-items-center">
                        <div class="form-text">크기: 1920 * 500 (gif/jpg/png)</div>
                      </div>
                    </div>
                  </td>
                </tr>
...
<? for($i=0;$i<count($image_sub);$i++){ ?>
                <tr>
				  ...
				  <? if($image_sub[$i][sub_file]){ ?>
                    <img src="/images/img/<?=$image_sub[$i][sub_file]?>" alt="메뉴 이미지" style="width:800px;height:200px;">
				  <? } ?>
                  </td>
                  <td>
                    <button class="btn btn-outline-secondary btn-sm" onclick="location.href='sub03.php?idx=<?=$image_sub[$i][idx]?>';">수정</button>
