              ...
              <div class="div_information">
                <table style="width:1200px;margin: 0 auto; margin-top:0px;" border="0" cellspacing="0" cellpadding="0">
                  <tbody style="border: 1px solid #cccccc"> 
                    ...
                    <tr>
                      <td width="170" height="50" align="left" bgcolor="#f2f2f2" style="padding-right: 5px;  padding-top: 2px; border-right:1px solid #CCCCCC; border-bottom:1px solid #CCCCCC;color: #888888;font-size: 14px;font-weight: bold">
                        년식 Model year
                      </td>
                    ...
                    <tr>
                      <td width="100%" height="50" align="center" colspan="4" bgcolor="#f2f2f2" style="padding-right: 5px;  padding-top: 2px; border-right:1px solid #CCCCCC; border-bottom:1px solid #CCCCCC;color: #888888;font-size: 14px;font-weight: bold">
