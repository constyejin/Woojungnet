    ...
    <!-- 추가 -->
     ...
     <div class="div_basic">
      <table style="width:1200px; margin:20 auto;">
                      ...
                      <td align="center" >
                        ...
                        <tr> 
                          <td colspan="4"  align="center" bgcolor="ffffff" style=""><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td height="100" colspan="2" align="left" style=""><div id="img_box" style="width:1200px; height:110px; overflow-y:scroll; padding:10px; border:1px solid #cccccc; margin-bottom:5px; "></td>
                            </tr>
                          </td>
                        </tr>
                      </td> 
       ...
       <? if($wc_idx){ ?>
        <tr>
          <td height="130" colspan="5" bgcolor="#FFFFFF" style="padding:10px; border:1px solid #cccccc "><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="13" colspan="2" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100" ></td><td width="100"></td><td width="100"></td><td width="100"></td><td width="100"></td><td width="100"></td><td width="100"></td><td width="100"></td>
                </tr>
              </td>
            </tr>
