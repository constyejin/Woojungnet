    ...
    <div class="content-container">
      <div class="content-wrap sub store-detail-preview">
        <div class="table-topper justify-content-center mt-5">
          <div class="center">
            <a href="./sub03_modify.php?idx=<?=$idx?>&trim_idx=<?=$trim_idx?>" class="btn btn-outline-secondary btn-sm">수정하기</a>
            <a href="./sub03.php" class="btn btn-outline-primary btn-sm">목록보기</a>
			<!--a href="./sub03_write.php?car_type1=<?=$mod_car[car_type1]?>&car_type2=<?=$mod_car[car_type2]?>&car_name=<?=$mod_car[car_name]?>" class="btn btn-outline-secondary btn-sm">트림추가하기</a>
...
?>
		...
		<button type="button" id="btn_ch<?=$mod_car_trim_one[idx]?>" class="btn btn-round btn-outline-dark btn-sm<?=$on_bt?>" onclick="location.href='sub03_view.php?idx=<?=$idx?>&trim_idx=<?=$mod_car_trim_bt[$i][idx]?>'"><?=$mod_car_trim_one[basic_price]?></button>
