...
$query="insert into sale_est (car_type1,car_type2,car_name,car_price,car_explain,car_add,car_catalog1,car_catalog2,car_catalog3,car_file,car_color1,car_color2,car_check1,car_check2,car_img,car_basic,car_choice1,car_choice2,car_check3,car_check4) select car_type1,car_type2,car_name,car_price,car_explain,car_add,car_catalog1,car_catalog2,car_catalog3,car_file,car_color1,car_color2,car_check1,car_check2,car_img,car_basic,car_choice1,car_choice2,car_check3,car_check4 from sale_out where idx='$idx' ";
mysql_query($query) or die(mysql_error()); 

$sale_out=sql_fetch("select * from sale_out where idx='$idx' order by idx desc ");
$sale_out_trim=sql_fetch("select * from sale_out_trim where idx='$trim_idx' ");
$sale_basic=sql_fetch("select * from option_basic where idx='".$sale_out_trim[trim_idx]."' ");
...
$est_price=$sale_out[car_price]+$tot_c1+$tot_c2;
...
trim_idx='$sale_out_trim[trim_idx]', 
...
est_cartype='".$sale_out[car_type1].">".$sale_out[car_type2]."', 
est_cartype1='".$sale_out[car_type1]."', 
est_cartype2='".$sale_out[car_type2]."', 
est_carname='$sale_out[car_name]', 
est_price='$est_price', 
est_regdate=now()
";
mysql_query($query) or die(mysql_error()); 
