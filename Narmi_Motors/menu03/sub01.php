...
if(!$st){
	$category_default=sql_fetch("select * from category where cate_type1='캠핑카' order by cate_list asc ");
...
$image_sub=sql_fetch("select * from image_sub where sub_type='sub' and sub_menu='캠핑카' order by idx desc ");
$structure=sql_fetch("select * from image_structure where st_type1='캠핑카' and st_type2='".$structure1."' ");
$sale_car=sql_list("select * from sale_car where car_type1='캠핑카' and car_type2='".$structure1."' $where order by idx desc ");
$category=sql_list("select * from category where cate_type1='캠핑카' order by cate_list asc ");
?>
