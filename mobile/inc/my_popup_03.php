...
<table border="0" align="center" cellpadding="0" cellspacing="0" style="padding:10px;width:100%;">
...
<form name="outForm" method="post" action="<?=$PHP_SELF?>"  onsubmit="return auction_submit(this)">
  ...
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="0" style="width:100%">
        ...
        <tr> 
          <td align="left" valign="top"> <table border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc" style="width:100%">
              ...
              <tr> 
                <td height="100"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="89" rowspan="6"><img src="http://skrcauto.co.kr/images/sub/dojang.gif" style="width:90px;"></td>
                  </tr>
                  <!--tr>
