...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" background="/images/main_bg.jpg"><table width="1000" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="218"><table border="0" cellspacing="0" cellpadding="0">
          <!--tr>
            <td width="678" height="193" align="right" valign="top" background="/images/main_bn.jpg"><table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="50" style="font-size:13px; line-height:19px;">1차 : ns1.woojungnet.com / IP : 1.234.83.172<br />
2차 : ns2.woojungnet.com / IP : 1.234.83.172</td>
                </tr>
              <tr>
                <td height="10">&nbsp;</td>
                </tr>
              <tr>
                <td height="50" style="font-size:13px; line-height:19px;">1차 : ns1.woojungnet.co.kr / IP : 175.125.93.22<br />
2차 : ns2.woojungnet.co.kr / IP : 175.125.93.22</td>
              </tr>
            </table></td>
...
?>
      ...
      <tr>
        <td height="218"><table width="1000" border="0" cellspacing="0" cellpadding="0">
          <tr>
<?
