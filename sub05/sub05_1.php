...
?>
			...
			<div class="search-box">
			   ...
			   <input type="hidden" name="gubun3" value="<?=$gubun3?>" >
				<table width="" border="0" cellspacing="0" cellpadding="0" style="margin-top:30px; border:1px solid #CCCCCC;">
					<tr>
						...
						<td style="text-align:right; padding-right: 30px">
							...
							<div class="filter-group">
								<a href="sub05_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&type=1">폐차</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub05_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&type=2">명의이전</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub05_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&evaltype=1">전손</a>&nbsp;&nbsp;ㅣ&nbsp;&nbsp;
								<a href="sub05_1.php?gubun2=<?=$gubun2?>&gubun3=<?=$gubun3?>&evaltype=2">분손</a>
							</div>
						</td>
						</form>
					</tr>
          ...
          <?
			...
			*/
			   $view_article = 20; // 한화면에 나타날 게시물의 총 개수  
				...
				$nowDate = date("YmdHi");
			   $where=" wc_gubun4!='1' and wc_gubun4!='2' ";
			   if($gubun2){
...
function auctionView(idx,gubun2) {
	window.location.href="sub05_1_view.php?gubun2="+gubun2+"&idx="+idx;
}
function zzim(idx){
